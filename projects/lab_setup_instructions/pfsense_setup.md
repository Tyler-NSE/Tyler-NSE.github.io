...
![Branching](https://tyler-nse.github.io/assets/img/pfsense_install/edit-vne.PNG)
...
![Branching](https://tyler-nse.github.io/assets/img/pfsense_install/vne-host-only.PNG)
...
![Branching](https://tyler-nse.github.io/assets/img/pfsense_install/new_vm_wiz_disk-image.PNG)
...
![Branching](https://tyler-nse.github.io/assets/img/pfsense_install/name_vm.PNG)
...
![Branching](https://tyler-nse.github.io/assets/img/pfsense_install/virtual_disk.PNG)

### Assign the VM resources

Before you click on next, you need to click on the customize hardware option here.

![Branching](https://tyler-nse.github.io/assets/img/pfsense_install/cust_hardware.PNG)
...
![Branching](https://tyler-nse.github.io/assets/img/pfsense_install/add_wan.PNG)
...
![Branching](https://tyler-nse.github.io/assets/img/pfsense_install/add_lan_adapter.PNG)
...
![Branching](https://tyler-nse.github.io/assets/img/pfsense_install/add_lan_host-only.PNG)
...
![Branching](https://tyler-nse.github.io/assets/img/pfsense_install/power-on_after_creation.PNG)

### PfSense installation

The pfsense installation now will begin. You can accept the copyright notice.

![Branching](https://tyler-nse.github.io/assets/img/pfsense_install/accept-copyright.PNG)

Click on Install on the pfSense installer welcome screen.

![Branching](https://tyler-nse.github.io/assets/img/pfsense_install/install_pfsense.PNG)

Select WAN interface and click OK. Leave network operation mode as default and select OK.

![Branching](https://tyler-nse.github.io/assets/img/pfsense_install/select_wan.PNG)

Select LAN interface and click OK. Leave network operation mode as default and select OK.

![Branching](https://tyler-nse.github.io/assets/img/pfsense_install/select_lan.PNG)
...
![Branching](https://tyler-nse.github.io/assets/img/pfsense_install/confirm_int_assign.PNG)

No active subscription for this lab, select Install CE

![Branching](https://tyler-nse.github.io/assets/img/pfsense_install/install-ce.PNG)

In the file system type and partitioning scheme step, leave defaults and select on OK to continue.

![Branching](https://tyler-nse.github.io/assets/img/pfsense_install/disk_select.PNG)

Select OK for ZFS Virtual Device configuration to set to Stripe.

![Branching](https://tyler-nse.github.io/assets/img/pfsense_install/zfs_vd.PNG)

Select OK for disk seection of previously configured 20G disk.

Select yes to destroy disk current contents.

![Branching](https://tyler-nse.github.io/assets/img/pfsense_install/destroy_ok.PNG)

Select version of pfSense to install and select OK; I chose 2.8.0, as it is the current stable version recommended.

![Branching](https://tyler-nse.github.io/assets/img/pfsense_install/version_to_install.PNG)
...
![Branching](https://tyler-nse.github.io/assets/img/pfsense_install/reboot.PNG)
...
![Branching](https://tyler-nse.github.io/assets/img/pfsense_install/after_reboot.PNG)
...
![Branching](https://tyler-nse.github.io/assets/img/pfsense_install/ping_1.PNG)
...
![Branching](https://tyler-nse.github.io/assets/img/pfsense_install/VNIC-LAN.PNG)
...
![Branching](https://tyler-nse.github.io/assets/img/pfsense_install/Assign-lan-ip.PNG)

![Branching](https://tyler-nse.github.io/assets/img/pfsense_install/assign-lan-ip_2.PNG)

Enter range for DHCP to assign; I chose 192.168.105.201-254.

![Branching](https://tyler-nse.github.io/assets/img/pfsense_install/dhcp_range-lan.PNG)
...
![Branching](https://tyler-nse.github.io/assets/img/pfsense_install/lan_host_adapter.PNG)
...
![Branching](https://tyler-nse.github.io/assets/img/pfsense_install/lan_host_ip.PNG)
...
![Branching](https://tyler-nse.github.io/assets/img/pfsense_install/pfsense_login.PNG)
...
![Branching](https://tyler-nse.github.io/assets/img/pfsense_install/pfsense_vm-tools.PNG)

You will get a message that says, VMware tools package was successfully installed.

![Branching](https://tyler-nse.github.io/assets/img/pfsense_install/pfsense_vm-tools2.PNG)
...
![Branching](https://tyler-nse.github.io/assets/img/pfsense_install/lan_host_ping.PNG)
